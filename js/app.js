   ...
   *************/
    ...
    var upTimePrice = setInterval(function() {
       ...
       $.getJSON(shimi_obj.root_url + '/wp-json/shimi/v1/timer?postid=' + id , function(res) {
            ...
            console.log(res);
            console.log(res[0] < 1 && res[1] < 1 && seconds < 6)
...
(function($){
  ...
  const uwaElement = $('.uwa_auction_condition, #uwa_auction_countdown, p.uwa_more_details, .uwa_more_details_display, .buy-now cart');
